    ...
    <Container>
        ...
        <div className="logo">
            <div className="logo_spot">
                {showNav ? null : <NavLink to="/" reloadDocument end><img src={logo} alt="logo" /></NavLink>}
            </div>
        </div>
        <div className="middle">
            <section className="top">
                ...
                <div className="phone_number">
                    <a href='tel: +2348187694700'><AiTwotonePhone style={{marginRight: "0.75rem", fontSize: "1.5rem"}}/> +234 802 226 8491 </a>
                </div>
