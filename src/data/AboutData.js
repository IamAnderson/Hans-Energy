export const AboutData = [
    {
        number: "1",
        title: "Vision",
        text: "To be a world class engineering solutions provider."
    },

    {
        number: "2",
        title: "Mission",
        text: "To understand our clients’ needs and provide qualitative solutions that add superior value to their operations using best global industry standards."
    },

    {
        ...
        text: "",
        subtitle1: "Team Work",
        text1: "“The one thing that would redeem mankind is co-operation” – Bertrand Russell. We believe in co-operation among our team, partners, clients and every stakeholder to achieve set objectives.",
