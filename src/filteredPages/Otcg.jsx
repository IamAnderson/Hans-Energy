...
const Otcg = ({ data, loading }) => {

  const otcg = data.filter(item => item.category === "otcg");
  const listOtcg = otcg.map((item, index) => 
  ...
  return (
    <>
        <Navbar />
        <FilterProductsNav title={"OTCG For Oil and Gas Industry"}/>
        <Container>
          <CategoryNav />
