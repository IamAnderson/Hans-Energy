...
const StainlessSteel = ({ data, loading }) => {

  const filtered = data.filter(item => item.category === "stainless");
  ...
  return (
    <>
        <Navbar />
        <FilterProductsNav title={"Stainless Steel"}/>
        <Container>
          <CategoryNav />
